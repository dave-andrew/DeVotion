...
@section('content')
    ...
    <div class="flex flex-col justify-center items-center">
        <h1 class="text-3xl font-bold">Give your workspace a name!</h1>
        @if($type == 'team')
            ...
            <div class="flex flex-col items-center">
                <label for="image" class="flex flex-col justify-center mb-6 cursor-pointer">
                    <div class="image-placeholder w-[200px] h-[200px] flex items-center justify-center border-2 border-dashed border-gray-300 rounded-lg overflow-hidden">
                        ...
                        <div id="imagePlaceholderText" class="absolute font-medium hover:text-blue-300 transition-all duration-500">Choose or add an image</div>
                    </div>
                    <input type="file" name="image" id="image" class="hidden">
                </label>
                <div class="flex flex-col w-full">
                    <label for="name" class= font-medium mb-1">Workspace Name</label>
                    <input type="text" name="name" id="name" class="auth-input w-full" value="{{ old('name') }}">
                    <label for="description" class= font-medium mb-1">Description</label>
                    <input type="text" name="description" id="description" class="auth-input" value="{{ old('description') }}">
