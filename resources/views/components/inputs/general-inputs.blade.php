<div class="w-full group relative mt-2">
    ...
    @if($data->type == 'text')
        @include('components.inputs.h1-input', ['data' => $data])
    @elseif($data->type == 'h2')
        @include('components.inputs.h2-input', ['data' => $data])
    @elseif($data->type == 'h3')
        @include('components.inputs.h3-input', ['data' => $data])
    @elseif($data->type == 'code')
        @include('components.inputs.code-input', ['data' => $data])
    @endif
</div>
